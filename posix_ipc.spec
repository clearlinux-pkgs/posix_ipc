...
Version  : 1.0.3
Release  : 31
URL      : http://pypi.debian.net/posix_ipc/posix_ipc-1.0.3.tar.gz
Source0  : http://pypi.debian.net/posix_ipc/posix_ipc-1.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1515855882
